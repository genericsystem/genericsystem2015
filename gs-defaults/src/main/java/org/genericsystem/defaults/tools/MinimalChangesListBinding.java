...
//
//public abstract class MinimalChangesListBinding<E> extends DiffListBinding<E> {
//
...
//	}
//
//	protected abstract List<E> computeNewList();
//
//	protected void doMinimalChanges() {
//		List<E> oldList = new ArrayList<E>(internal);
//		List<E> newList = computeNewList();
...
//				if (e.getValue())
//					internal.add(e.getKey());
//				else
//					internal.remove(index);
//			}
//		}
//		if (!internal.equals(newList))
