...
public class GsDeploymentConfig extends JsonObject {
	...
	public GsDeploymentConfig addEngine(String engineValue,
			String repositoryPath) {
		super.getJsonArray("engines").add(
				new JsonObject().put("engineValue", engineValue).put(
						"engineRepositoryPath", repositoryPath));
		return this;
	}
}