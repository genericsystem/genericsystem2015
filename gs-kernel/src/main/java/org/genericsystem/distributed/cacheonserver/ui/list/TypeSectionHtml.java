...
public class TypeSectionHtml<M extends GenericCompositeModel<SUBMODEL>, SUBMODEL extends GenericModel> extends HtmlSection<M> {
	...
	protected void initChildren() {
		new InstanceSectionHtml<SUBMODEL>(this).forEach(GenericCompositeModel<SUBMODEL>::getSubModels);
	}
