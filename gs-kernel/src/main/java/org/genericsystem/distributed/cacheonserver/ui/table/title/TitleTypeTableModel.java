...
public class TitleTypeTableModel extends TypeTableModel {
	...
	public TitleTypeTableModel(Generic generic, Function<Generic, String> stringExtractor, Function<Generic, ObservableList<Generic>> observableListExtractor, Function<CompositeConf<CompositeModel<GenericModel>>, InstanceRowModel> rowBuilder,
		...
		titleRowModel = new ReadOnlyObjectWrapper<>(titleRowBuilder.apply(new CompositeConf<GenericModel>(generic, observableListExtractor, attribute -> titleCellBuilder.apply(attribute, GenericModel.SIMPLE_CLASS_EXTRACTOR))));
	}
