...
public class Utils {
	...
	static public <PARENTNODE extends HtmlNode> Function<PARENTNODE, List<?>> getHtmlChildren(Element<PARENTNODE> parent) {

		Function<PARENTNODE, List<HtmlNode>> nodeJsChildren = parentNodeJs -> new AbstractList<HtmlNode>() {
