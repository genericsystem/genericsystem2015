...
public class AnnotationTest extends AbstractTest {
	...
	public void test001() {
		LightServerEngine engine = new LightServerEngine(Vehicle.class, Human.class, Myck.class);
	...
	public void test002() {
		LightServerEngine engine = new LightServerEngine(Vehicle.class);
		Generic vehicle = engine.find(Vehicle.class);
		catchAndCheckCause(() -> vehicle.remove(), IllegalAccessException.class);
	}

	public void test003() {
		LightServerEngine engine = new LightServerEngine(OtherVehicle.class);
	...
	public void test005() {
		LightServerEngine engine = new LightServerEngine(VehicleType.class);
	...
	public void test006() {
		LightServerEngine engine = new LightServerEngine(OtherVehicleType.class);
	...
	public void test008() {
		LightServerEngine engine = new LightServerEngine(MyAudi.class);
	...
	public void test009() {
		catchAndCheckCause(() -> new LightServerEngine(MyBmw.class), InstantiationException.class);
		catchAndCheckCause(() -> new LightServerEngine(MyMercedes.class), InstantiationException.class);
	}

	public void test010() {
		LightServerEngine engine = new LightServerEngine(Vehicle.class, Car.class, myCar.class);
		Generic vehicle = engine.find(Vehicle.class);
	...
	public void test011() {
		LightServerEngine engine = new LightServerEngine(Vehicle.class, Power.class);
		Generic vehicle = engine.find(Vehicle.class);
	...
	public void test012() {
		LightServerEngine engine = new LightServerEngine(V123.class);
	...
	public void test006_AttributeOnAttribute() {
		LightServerEngine engine = new LightServerEngine(ElectrikPower.class, Unit.class);
	...
	public void test007_Relation() {
		LightServerEngine engine = new LightServerEngine(Vehicle.class, Human.class, HumanPossessVehicle.class);
	...
	public void test008_SubRelation() {
		LightServerEngine engine = new LightServerEngine(Car.class, Human.class, HumanPossessCar.class);
	...
	public void test009_SymetricSuperRelation() {
		LightServerEngine engine = new LightServerEngine(Car.class, Human.class, Man.class, HumanPossessVehicle.class, ManPossessCar.class);
		engine.find(Car.class);
		Generic human = engine.find(Human.class);
	...
	public void test010_TernaryRelation() {
		LightServerEngine engine = new LightServerEngine(Vehicle.class, Human.class, Time.class, HumanPossessVehicleTime.class);
		engine.find(Vehicle.class);
		Generic human = engine.find(Human.class);
	...
	public void test011_getDirectSubVertexsWithDiamondProblem() {
		LightServerEngine engine = new LightServerEngine(GraphicComposite.class, Window.class, Selectable.class, SelectableWindow.class);
	...
	public void test012_Value() {
		LightServerEngine engine = new LightServerEngine(SelectableWindow.class, Size.class, Selected.class, MySelectableWindow.class);
		Generic selectableWindow = engine.find(SelectableWindow.class);
	...
	public void test013_MultiInheritanceComplexStructural() {
		LightServerEngine engine = new LightServerEngine(Games.class, Children.class, Vehicle.class, Human.class, ChildrenGames.class, Transformer.class, TransformerChildrenGames.class);
	...
	public void test014_MultiInheritanceComplexValue() {
		LightServerEngine engine = new LightServerEngine(MyGames.class, MyChildren.class, MyVehicle.class, Myck.class, MyChildrenGames.class, MyTransformer.class, MyTransformerChildrenGames.class);
		Generic myVehicle = engine.find(MyVehicle.class);
		Generic myck = engine.find(Myck.class);
	...
	public void testxxx() {
		LightServerEngine engine = new LightServerEngine(TransformerChildrenGames.class, MyTransformerChildrenGames.class);
		Generic transformerChildrenGames = engine.find(TransformerChildrenGames.class);
		Generic myTransformerChildrenGames = engine.find(MyTransformerChildrenGames.class);
	...
	public void testxxxx() {
		LightServerEngine engine = new LightServerEngine(ChildrenGames.class, MyChildrenGames.class, MyGames.class, MyChildren.class);
	...
	public void test015_propertyConstraint() {
		LightServerEngine engine = new LightServerEngine(Options.class);
	...
	public void test020_dependencies() {
		LightServerEngine engine = new LightServerEngine(MicroCar.class);
		Generic options = engine.find(Options.class);
	...
	public void testdsd() {
		LightServerEngine engine = new LightServerEngine(Power.class);
		Generic power = engine.find(Power.class);
