...
public class AnnotationTest extends AbstractTest {
	...
	public void test001_Generic() {
		ServerEngine engine = new ServerEngine(Vehicle.class, Human.class, Myck.class);
	...
	public void test001_remove() {
		ServerEngine engine = new ServerEngine(Vehicle.class);
		Generic vehicle = engine.find(Vehicle.class);
		catchAndCheckCause(() -> vehicle.remove(), IllegalAccessException.class);
	}

	public void test002_remove() {
		ServerEngine engine = new ServerEngine(OtherVehicle.class);
	...
	public void test002_instanceof() {
		ServerEngine engine = new ServerEngine(VehicleType.class);
	...
	public void test0022_instanceof() {
		ServerEngine engine = new ServerEngine(OtherVehicleType.class);
	...
	public void test003_instanceof() {
		ServerEngine engine = new ServerEngine(MyAudi.class);
	...
	public void test004_instanceof() {
		...
		catchAndCheckCause(() -> new ServerEngine(MyBmw.class), InstantiationException.class);
		catchAndCheckCause(() -> new ServerEngine(MyMercedes.class), InstantiationException.class);
	}
	...
	public void test002_SuperGeneric() {
		ServerEngine engine = new ServerEngine(Vehicle.class, Car.class, myCar.class);
		Generic vehicle = engine.find(Vehicle.class);
	...
	public void test003_Attribute() {
		ServerEngine engine = new ServerEngine(Vehicle.class, Power.class);
		Generic vehicle = engine.find(Vehicle.class);
	...
	public void test004_AttributeValue() {
		ServerEngine engine = new ServerEngine(V123.class);
	...
	public void test005_SuperAttribute() {
		ServerEngine engine = new ServerEngine(Car.class, ElectrikPower.class);
		Generic car = engine.find(Car.class);
	...
	public void test006_AttributeOnAttribute() {
		ServerEngine engine = new ServerEngine(ElectrikPower.class, Unit.class);
		Generic electrikPowerCar = engine.find(ElectrikPower.class);
	...
	public void test007_Relation() {
		ServerEngine engine = new ServerEngine(Vehicle.class, Human.class, HumanPossessVehicle.class);
	...
	public void test008_SubRelation() {
		ServerEngine engine = new ServerEngine(Car.class, Human.class, HumanPossessVehicle.class, HumanPossessCar.class);
	...
	public void test009_SymetricSuperRelation() {
		ServerEngine engine = new ServerEngine(Car.class, Human.class, Man.class, HumanPossessVehicle.class, ManPossessCar.class);
		engine.find(Car.class);
		Generic human = engine.find(Human.class);
	...
	public void test010_TernaryRelation() {
		ServerEngine engine = new ServerEngine(Vehicle.class, Human.class, Time.class, HumanPossessVehicleTime.class);
		engine.find(Vehicle.class);
		Generic human = engine.find(Human.class);
	...
	public void test011_getDirectSubGenericsWithDiamondProblem() {
		ServerEngine engine = new ServerEngine(GraphicComposite.class, Window.class, Selectable.class, SelectableWindow.class);
	...
	public void test012_Value() {
		ServerEngine engine = new ServerEngine(SelectableWindow.class, Size.class, Selected.class, MySelectableWindow.class);
		Generic selectableWindow = engine.find(SelectableWindow.class);
	...
	public void test013_MultiInheritanceComplexStructural() {
		ServerEngine engine = new ServerEngine(Games.class, Children.class, Vehicle.class, Human.class, ChildrenGames.class, Transformer.class, TransformerChildrenGames.class);
	...
	public void test014_MultiInheritanceComplexValue() {
		ServerEngine engine = new ServerEngine(MyGames.class, MyChildren.class, MyVehicle.class, Myck.class, MyChildrenGames.class, ChildrenGames.class, MyTransformer.class, Transformer.class, TransformerChildrenGames.class,
	...
	public void test020_dependencies() {
		ServerEngine engine = new ServerEngine(Voiture.class);
		Generic puissance = engine.find(Puissance.class);
