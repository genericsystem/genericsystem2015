...
public class Engine implements Generic, DefaultRoot<Generic>, MethodHandler {
	...
	private final Engine cacheEngine;
	...
	public Engine(String engineValue, String persistentDirectoryPath, Class<?>... userClasses) {
		this.cacheEngine = new Engine(engineValue, persistentDirectoryPath, userClasses);
		newCache().start();
	}
	...
	public org.genericsystem.kernel.Engine getConcurrencyEngine() {
		return cacheEngine;
	}
