...
public class TypeWrapper {
	...
	public TypeWrapper(Generic g) {
		...
		instanceWrapperList = new Transformation<InstanceWrapper, Generic>(FXCollections.observableArrayList(generic.getInstances().toList()), gen -> new InstanceWrapper(gen));
	}
	...
	public static void init(Element<HBox> parent) {
		new GSLabel(parent, TypeWrapper::getObservable).setPrefWidth(250);
