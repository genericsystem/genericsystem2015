...
public class GenericCrud extends Crud {
	...
	@Override
	public void add() {
		generic.addInstance(getInstanceValue(), new TransformationObservableList<>(listCombobox, combo -> combo.getSelectedItem().getValue()).toArray(new Generic[listCombobox.size()]));
	}
