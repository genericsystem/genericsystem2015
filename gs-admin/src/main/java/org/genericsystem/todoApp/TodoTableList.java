...
public class TodoTableList {
	...
	public Node init() {
		...
		Element mainVBox = new Element(null, VBox.class, Binding.setValueProperty(VBox::prefHeightProperty, 200));
		...
		Element columnsTableItems = new Element(todoTableView, TableColumn.class, getColumns, Arrays.asList(Binding.forEach(TodoTableList::getColumns)), Binding.setValueProperty(Column::prefWidthProperty, 100), Binding.setValueProperty(
