...
public class RobustTextDetectorDemo extends AbstractApp {
	...
	private Image[] doWork() {
		...
		images[1] = new Img(manager.getMserAndCannyMask(), false).toJfxImage();
		ref = trace("mserAndCanny", ref);

		images[2] = new Img(manager.getMserAndCannyGrownMask(), false).toJfxImage();
		ref = trace("grow", ref);

		images[3] = new Img(manager.getEdgeEnhancedMserMask(), false).toJfxImage();
		ref = trace("edgeEnhancedMser", ref);

		images[4] = new Img(manager.getEdgeEnhanceMserCCMask(), false).toJfxImage();
		ref = trace("cc", ref);

		images[5] = new Img(manager.getFilteredStrokeWidthMask(), false).toJfxImage();
		ref = trace("swt", ref);
		...
		images[6] = new Img(bounding_region, false).toJfxImage();
