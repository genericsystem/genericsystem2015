...
public class LayoutComparisonTestFigure extends AbstractApp {
	...
	protected void fillGrid(GridPane mainGrid) {
		...
		// Containing Layout A
		Layout layoutA = new Layout(null, 0.1, 0.9, 0.1, 0.9);
		...
		// Contained Layout B
		Layout layoutB = new Layout(null, 0.1, 0.9, 0.1, 0.9);
