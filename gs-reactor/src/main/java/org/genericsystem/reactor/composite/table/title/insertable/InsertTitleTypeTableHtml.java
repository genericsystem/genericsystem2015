package org.genericsystem.reactor.composite.table.title.insertable;
...
//
//	public InsertTitleTypeTableHtml(HtmlElement<?, ?, ?> parent, StringExtractor extractor, ModelConstructor<M, InstanceRowModel> constructor) {
